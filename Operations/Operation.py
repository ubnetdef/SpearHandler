...
from Shells.MythicClient import MythicC2
...
class Operation():
    def __init__(self, inScopeIPs=[], clients=ClientsData()):
        ...
        self.metasploitServer = None
        self.mythicServer = None
    ...
    async def startOperation(self, metasploitServer: MetasploitC2, mythicServer: MythicC2):
        self.mythicServer = mythicServer
